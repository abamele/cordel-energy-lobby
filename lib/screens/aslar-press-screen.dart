...
class AslarPressScreen extends StatefulWidget {
  const AslarPressScreen({super.key});

  @override
  State<AslarPressScreen> createState() => _AslarPressScreenState();
}

class _AslarPressScreenState extends State<AslarPressScreen>
